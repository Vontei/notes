...
### Exercise/Assessment
- [HTML and CSS Tutorial](https://github.com/mjhea0/thinkful-html/tree/master/resume) (don't do the exercise - "Your turn!"). When done, create your own resume! Make sure to create a new project called *YOUR_LASTNAME-basic-resume* and then push this to Github.
